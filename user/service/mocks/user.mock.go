...
func (m *MockUserService) FindById(ctx context.Context, uid int64) (domain0.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) FindOrCreate(ctx context.Context, phone string) (domain0.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) FindOrCreateByWechat(ctx context.Context, info domain.WechatInfo) (domain0.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Login(ctx context.Context, email, password string) (domain0.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserService) Signup(ctx context.Context, u domain0.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserService) UpdateNonSensitiveInfo(ctx context.Context, user domain0.User) error {
	m.ctrl.T.Helper()
